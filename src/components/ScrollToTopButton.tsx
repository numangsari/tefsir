...
export function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      title="En üste çık"
      className="fixed bottom-20 md:bottom-6 left-4 md:left-6 z-30 flex h-11 w-11 items-center justify-center rounded-full bg-emerald-700 text-white shadow-lg ring-1 ring-black/5 hover:bg-emerald-800 transition-colors"
    >
